...
<html lang="en">
  ...
  <body>
        <header>
            <img src="imagenes/logo5.jpg" alt="Transmediterranea" height="80">
        ...
        <div id="uno">
            <div class="container">
                <div class="row">
                     ...
                     <h1>titulo</h1>
                         ...
                         <form action="recibeformulario.php">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="sexo" type="radio" name="exampleRadios" id="exampleRadios1" value="varon">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="sexo" id="exampleRadios" value="mujer">
                    ...
                    <div class="col">
                        <img src="imagenes/imagen.jpg" alt="" width="100%">
                    </div>
                </div>    
            </div>
        </div>
        ...
        <div id="dos">
            <img src="imagenes/imagen3.jpg" alt="" width="100%">
        </div>
